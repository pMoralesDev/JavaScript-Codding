    ...
    navigator.getBattery().then((batt)=>{
        updateBattery = () => {
            ...
            if (level == 100) {
                ...
                batteryLiquid.computedStyleMap.height="103%"
            }else if (level <= 20 && !batteryStatus.charging) {
                batteryStatus.innerHTML = `Low Cahrge <i class="ri-flashlight-line animated.green"></i>`
